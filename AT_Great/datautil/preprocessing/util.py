...
'''
@author: https://github.com/intellsensing/axopy/edit/master/axopy/features/util.py
'''
...
def rolling_window(array, n):
    ...
    --------
    >>> import numpy as np
    >>> from source.data.util import rolling_window
...
def inverted_t_window(n, p=0.25, a=0.5):
    ...
    Examples
    --------
    # >>> from src.data.util import inverted_t_window
    # >>> inverted_t_window(8)
...
def trapezoidal_window(n, p=0.25):
    ...
    Examples
    --------
    >>> from source.data.util import trapezoidal_window
